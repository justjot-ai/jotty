...
class SwarmTester:
    ...
    async def test_arxiv_swarm(self) -> Dict[str, Any]:
        ...
        try:
            from Jotty.core.intelligence.orchestration.swarms.arxiv_learning_swarm import (
                learn_paper,
            )
    ...
    async def test_research_swarm(self) -> Dict[str, Any]:
        ...
        try:
            ...
            from Jotty.core.intelligence.orchestration.swarms.research_swarm.types import (
                ResearchConfig,
            )
