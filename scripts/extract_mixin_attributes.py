...
def main():
    ...
    mixin_files = []
    for pattern in ["core/intelligence/**/*_mixin.py", "core/intelligence/**/protocols/*.py"]:
    ...
    for attr in all_attrs_set:
        if "config" in attr.lower():
            ...
            "report" in attr.lower()
            or "figure" in attr.lower()
            or "section" in attr.lower()
            or "chart" in attr.lower()
        ):
