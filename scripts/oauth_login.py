...
Examples:
  ...
  python3 scripts/oauth_login.py --provider google --email user@example.com --password pass --2fa-code 123456
    ...
    parser.add_argument(
        "--profile-dir", help="Browser profile directory (default: ~/.oauth_browser)"
    )
    parser.add_argument(
        "--service-url", default="https://notebooklm.google.com", help="Target service URL"
    )
    parser.add_argument(
    ...
    if result.get("success"):
        ...
        if result.get("needs_2fa"):
            ...
            print(
                "   python3 scripts/oauth_login.py --provider google --email ... --password ... --2fa-code <code>"
            )
        sys.exit(1)
