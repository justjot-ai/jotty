    ...
    try:
        async with async_playwright() as p:
            ...
            browser = await p.chromium.launch_persistent_context(
                user_data_dir=str(profile_path), headless=True  # Don't need to show browser
            )
...
def main():
    parser = argparse.ArgumentParser(description="Extract cookies from NotebookLM browser profile")
    parser.add_argument(
        "--profile-dir",
