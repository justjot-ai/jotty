...
```python
from Jotty.core.intelligence.orchestration.swarms.{swarm_snake} import {swarm_pascal}
...
```python
from Jotty.core.intelligence.orchestration.swarms.{swarm_snake}.types import {swarm_pascal}Config
