...
header-includes:
  ...
  - \fancyhead[LO]{\small\textit{Titanic Survival Prediction}}
  ...
  # Hyperref (load last)
  - \usepackage{hyperref}
  - \hypersetup{pdfauthor={Jotty SwarmMLComprehensive}, pdftitle={Titanic Survival Prediction}, pdfsubject={Machine Learning Analysis}}
...
\begin{center}
\vspace*{2cm}
{\Huge\bfseries\color{NavyBlue} Titanic Survival Prediction}
\vspace{0.5cm}

{\Large\textit{Predict passenger survival on the Titanic using demographic and ticket information.}}
\vspace{2cm}
...
|-------|----------|---------|------------|----------|
| Logistic Regression | 0.7765 | ±0.0217 | 0.8244 | 0.54 |
| Gradient Boosting | 0.8023 | ±0.0215 | 0.8244 | 0.16 |
| Random Forest | 0.7612 | ±0.0251 | 0.7786 | 0.20 |
...
*Report generated by Jotty SwarmMLComprehensive on 2026-02-05 03:14:06*
...
**Report Generated:** 2026-02-05 03:14:06
