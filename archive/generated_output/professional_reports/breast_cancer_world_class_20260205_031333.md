...
header-includes:
  ...
  - \definecolor{WarningGold}{RGB}{214,158,46}
  - \definecolor{DangerRed}{RGB}{229,62,62}
  ...
  - \fancyhead[LO]{\small\textit{Breast Cancer Diagnosis Analysis}}
  - \fancyhead[RE]{\small\textit{Jotty SwarmMLComprehensive}}
  - \fancyfoot[C]{\small\textcolor{gray}{Jotty ML Comprehensive Report}}
  - \renewcommand{\headrulewidth}{0.4pt}
  - \renewcommand{\footrulewidth}{0.2pt}

  # Title page styling
  - \usepackage{titling}
  - \pretitle{\begin{center}\LARGE\bfseries\color{NavyBlue}}
  ...
  - \titleformat{\subsection}{\large\bfseries\color{TableHeader}}{\thesubsection}{1em}{}
  ...
  # Hyperref (load last)
  - \usepackage{hyperref}
  - \hypersetup{pdfauthor={Jotty SwarmMLComprehensive}, pdftitle={Breast Cancer Diagnosis Analysis}, pdfsubject={Machine Learning Analysis}}
...
\begin{center}
\vspace*{2cm}
{\Huge\bfseries\color{NavyBlue} Breast Cancer Diagnosis Analysis}
\vspace{0.5cm}

{\Large\textit{Predict breast cancer diagnosis (malignant vs benign) from digitized cell nuclei images using machin}}
\vspace{2cm}

{\large Jotty SwarmMLComprehensive}
\vspace{0.3cm}

{\large February 05, 2026}
\vspace{3cm}

\includegraphics[width=0.3\textwidth]{professional_reports/figures/feature_importance.png}
\vfill

{\small\textit{Generated by Jotty SwarmMLComprehensive}}
\vspace{0.5cm}

{\small\textcolor{gray}{Comprehensive ML Analysis Report}}
\end{center}
\newpage
...
![Feature Distributions](professional_reports/figures/distributions.png)
...
![Outlier Boxplot](professional_reports/figures/outlier_boxplot.png)
...
![Correlation Matrix](professional_reports/figures/correlation_matrix.png)
...
![VIF Analysis](professional_reports/figures/vif_analysis.png)
...
|-------|----------|---------|------------|----------|
| Logistic Regression | 0.9802 | ±0.0128 | 0.9825 | 0.67 |
| Random Forest | 0.9538 | ±0.0235 | 0.9561 | 0.20 |
| Gradient Boosting | 0.9560 | ±0.0139 | 0.9561 | 0.50 |
...
![Learning Curves](professional_reports/figures/learning_curves.png)
...
![CV Analysis](professional_reports/figures/cv_analysis.png)
...
![Calibration Curve](professional_reports/figures/calibration.png)
...
![Lift and Gain Charts](professional_reports/figures/lift_gain.png)
...
![Threshold Analysis](professional_reports/figures/threshold_optimization.png)
...
![Error Analysis](professional_reports/figures/error_analysis.png)
...
![SHAP Summary](professional_reports/figures/shap_summary.png)

### SHAP Feature Importance Bar

![SHAP Bar Plot](professional_reports/figures/shap_bar.png)
...
![SHAP Dependence](professional_reports/figures/shap_dependence.png)
...
![SHAP Waterfall](professional_reports/figures/shap_waterfall.png)
...
*Report generated by Jotty SwarmMLComprehensive on 2026-02-05 03:13:47*
...
**Report Generated:** 2026-02-05 03:13:47
