...
class WebSocketManager:
    ...
    async def connect(
        self, websocket: Any, session_id: str, user_id: str = "anonymous"
    ) -> WebSocketConnection:
        """
        ...
        """
        conn = WebSocketConnection(websocket=websocket, session_id=session_id, user_id=user_id)
    ...
    async def send_error(self, session_id: str, error: str):
        ...
        """
        await self.send_to_session(
            session_id, {"type": "error", "error": error, "timestamp": datetime.now().isoformat()}
        )
