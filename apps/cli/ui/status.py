...
AGENT_ICONS = {
    'analyze': '\U0001f9e0', 'analyzing': '\U0001f9e0',
    'search': '\U0001f50d', 'searching': '\U0001f50d',
    'generate': '\U0001f4dd', 'generating': '\U0001f4dd',
    'write': '\u270d\ufe0f', 'writing': '\u270d\ufe0f',
    'read': '\U0001f4d6', 'reading': '\U0001f4d6',
    'save': '\U0001f4be', 'saving': '\U0001f4be',
    'send': '\U0001f4e4', 'sending': '\U0001f4e4',
    'decision': '\U0001f3af', 'deciding': '\U0001f3af',
    'output': '\U0001f4e6', 'created': '\u2705',
}
...
def create_status_callback(renderer: Any) -> Callable[[str, str], None]:
    ...
    def status_callback(stage: str, detail: str = '') -> Any:
        ...
        # Tool success
            ...
            renderer.tool_output(stage.replace('\u2713', '').strip(), detail if '/' in detail else None)
