...
async def research_and_document_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not research_topic:
        return {"success": False, "error": "research_topic is required"}
    ...
    try:
        ...
        create_params = {"title": f"Research: {research_topic}", "content": documentation_content}
        ...
        return {"success": False, "error": result.get("error", "Failed to create documentation")}
...
def _synthesize_research(
    topic: str, sources: List[Dict], output_format: str, include_citations: bool
) -> str:
