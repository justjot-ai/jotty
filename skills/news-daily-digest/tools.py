...
TOPIC_FEEDS: Dict[str, List[Dict[str, str]]] = {
    "ai": [
        ...
        {"name": "AI News", "url": "https://news.google.com/rss/search?q=artificial+intelligence&hl=en"},
    ],
    "tech": [
    ...
    "business": [
        ...
        {"name": "Reuters Business", "url": "https://news.google.com/rss/search?q=reuters+business&hl=en"},
    ],
    "science": [
    ...
    "startups": [
        {"name": "Startup News", "url": "https://news.google.com/rss/search?q=startups+funding&hl=en"},
    ],
    "climate": [
...
def _fetch_rss_articles(feed_url: str, max_articles: int = 5) -> List[Dict[str, str]]:
    ...
    for item in items[:max_articles]:
        ...
        article["title"] = _clean_html(title_el.text) if title_el is not None and title_el.text else "Untitled"
