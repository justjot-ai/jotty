...
def convert_to_pdf_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if not input_file:
            return {"success": False, "error": "input_file parameter is required"}
        ...
        cmd = [
            ...
            "-V",
            f"geometry:{pandoc_size},margin=1in",
            "-V",
            "fontsize=11pt",  # Ensure readable font size
            "-V",
            "linestretch=1.15",  # Better line spacing (1.15 = 15% extra)
            "-V",
            "urlcolor=blue",  # Make URLs blue
            "-V",
            "linkcolor=blue",  # Make links blue
        ...
        if result.returncode != 0:
            return {"success": False, "error": f"Pandoc conversion failed: {result.stderr}"}
        ...
        return {"success": False, "error": "Conversion timed out after 60 seconds"}
    except Exception as e:
        return {"success": False, "error": f"Error converting to PDF: {str(e)}"}
...
def convert_to_epub_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if not output_path.exists():
            return {"success": False, "error": "EPUB file was not created"}
        ...
        return {"success": False, "error": f"Error converting to EPUB: {str(e)}"}
...
def convert_to_docx_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "error": f"Error converting to DOCX: {str(e)}"}
...
def convert_to_html_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if not output_path.exists():
            return {"success": False, "error": "HTML file was not created"}
        ...
        return {"success": False, "error": f"Error converting to HTML: {str(e)}"}
...
def convert_to_markdown_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if not output_path.exists():
            return {"success": False, "error": "Markdown file was not created"}
        ...
        return {"success": False, "error": f"Error converting to Markdown: {str(e)}"}
