...
def get_process_info_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if pid is None:
            return {"success": False, "error": "pid parameter is required"}
        ...
        return {"success": False, "error": f"Error getting process info: {str(e)}"}
...
def kill_process_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            return {"success": True, "pid": pid, "method": method}
        except psutil.NoSuchProcess:
            return {"success": False, "error": f"Process {pid} not found"}
        except psutil.AccessDenied:
            return {
