...
def encode_text_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            'success': False,
            'error': f'Error encoding text: {str(e)}'
        }
...
def decode_text_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            'success': False,
            'error': f'Error decoding text: {str(e)}'
        }
...
def format_text_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            'success': False,
            'error': f'Error formatting text: {str(e)}'
        }
...
def count_text_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            'success': False,
            'error': f'Error counting text: {str(e)}'
        }
...
def replace_text_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            'success': False,
            'error': f'Error replacing text: {str(e)}'
        }
