...
def check_weather_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "error": "Request timeout while fetching weather data"}
    except requests.exceptions.RequestException as e:
        return {"success": False, "error": f"Failed to fetch weather data: {str(e)}"}
    except (KeyError, IndexError) as e:
        return {"success": False, "error": f"Invalid response format from weather API: {str(e)}"}
...
def get_weather_forecast_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": True, "location": location, "forecast": forecast_list}

    except requests.exceptions.Timeout:
        return {"success": False, "error": "Request timeout while fetching forecast data"}
    except requests.exceptions.RequestException as e:
