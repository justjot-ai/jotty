...
async def write_internal_comm_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not comm_type:
        return {"success": False, "error": "comm_type is required"}
    ...
    try:
        ...
        if result.get("success"):
            ...
            return {"success": True, "communication": communication, "format": output_format}

        return {"success": False, "error": "Failed to generate communication"}
