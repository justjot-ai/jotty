...
class SmartDataExtractor:
    ...
    async def extract(
        self, data_source: Any, param_name: str, context_key: Optional[str] = None
    ) -> Any:
        """
        ...
        """
        logger.debug(
            f" SmartDataExtractor: Extracting '{param_name}' from {type(data_source).__name__}"
        )
            ...
            try:
                ...
                if result is not None:
                    ...
                    self.extraction_stats.append(
                        {"param": param_name, "strategy": strategy_name, "success": True}
                    )
                    return result
        ...
        self.extraction_stats.append({"param": param_name, "strategy": "none", "success": False})
        return None

    async def _extract_as_string(
        self, data_source: Any, param_name: Any, context_key: Any
    ) -> Optional[str]:
    ...
    async def _extract_as_callable(
        self, data_source: Any, param_name: Any, context_key: Any
    ) -> Optional[Any]:
    ...
    async def _extract_from_dict_exact(
        self, data_source: Any, param_name: Any, context_key: Any
    ) -> Optional[Any]:
    ...
    async def _extract_via_method_exact(
        self, data_source: Any, param_name: Any, context_key: Any
    ) -> Optional[Any]:
    ...
    async def _extract_as_attribute(
        self, data_source: Any, param_name: Any, context_key: Any
    ) -> Optional[Any]:
    ...
    async def _extract_str_fallback(
        self, data_source: Any, param_name: Any, context_key: Any
    ) -> Optional[str]:
