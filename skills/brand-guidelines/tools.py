...
BRAND_FONTS = {"heading": "Poppins", "body": "Lora"}  # Fallback: Arial  # Fallback: Georgia
...
async def _style_pptx(input_path: Path, output_path: Path) -> Dict:
    ...
    styles_applied = {"slides_styled": 0, "colors_applied": [], "fonts_applied": []}
    ...
    return {"styles_applied": styles_applied}
...
async def _style_docx(input_path: Path, output_path: Path) -> Dict:
    ...
    styles_applied = {"paragraphs_styled": 0, "colors_applied": [], "fonts_applied": []}
