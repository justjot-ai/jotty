...
async def media_production_pipeline_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if workflow_type in ['enhance', 'full'] and params.get('enhance_image', workflow_type == 'full'):
                ...
                if enhance_tool:
                    ...
                    if not image_path:
                        ...
                        if enhance_result.get('success'):
                            ...
                            logger.warning(f"⚠️  Image enhancement failed: {enhance_result.get('error')}")
        
        # Step 2: Create design (Processor)
        if workflow_type in ['design', 'full'] and params.get('create_design', workflow_type == 'full'):
