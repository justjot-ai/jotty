...
def _validate_vault(vault_path: str) -> Optional[Dict[str, Any]]:
    ...
    if not os.path.exists(vault_path):
        return {"success": False, "error": f"Vault not found: {vault_path}"}
    if not os.path.isdir(vault_path):
        return {"success": False, "error": f"Vault path is not a directory: {vault_path}"}
    return None
...
def list_notes_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": True, "notes": notes, "count": len(notes), "vault_path": vault_path}
    except Exception as e:
        return {"success": False, "error": f"Error listing notes: {str(e)}"}
...
def read_note_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if not note_path:
            return {"success": False, "error": "note_path parameter is required"}
        ...
        return {"success": False, "error": f"Encoding error reading note: {str(e)}"}
    except Exception as e:
        return {"success": False, "error": f"Error reading note: {str(e)}"}
...
def search_notes_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "error": f"Error searching notes: {str(e)}"}
...
def get_backlinks_tool(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        link_patterns = [
            ...
            re.compile(
                r"\[\[" + re.escape(note_path.rstrip(".md")) + r"(\|[^\]]+)?\]\]", re.IGNORECASE
            ),
        ]
        ...
        return {"success": False, "error": f"Error finding backlinks: {str(e)}"}
