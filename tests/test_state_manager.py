...
@pytest.mark.unit
@pytest.mark.skip(
    reason="core.orchestration.state_manager module was removed; StateManager no longer exists"
)
...
class TestSwarmStateManagerDeep:
    ...
    def test_get_current_state_query_from_shared_context(self):
        ...
        manager = _make_swarm_state_manager(shared_context={"query": "analyze stock trends"})
    ...
    def test_get_current_state_goal_from_shared_context(self):
        ...
        manager = _make_swarm_state_manager(shared_context={"goal": "build a dashboard"})
    ...
    def test_load_state_restores_tool_usage(self):
        ...
        manager = _make_swarm_state_manager()
        manager.swarm_tool_usage = {"successful": {"search": 5}, "failed": {"db_query": 2}}
    ...
    def test_get_current_state_query_truncated_to_200_chars(self):
        ...
        long_query = "x" * 300
        manager = _make_swarm_state_manager(shared_context={"query": long_query})
