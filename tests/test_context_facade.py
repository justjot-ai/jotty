...
class TestContextFacade:
    ...
    def test_get_context_manager_returns_manager(self):
        from Jotty.core.context.facade import get_context_manager
    ...
    def test_get_context_guard_returns_guard(self):
        from Jotty.core.context.facade import get_context_guard
    ...
    def test_get_content_gate_returns_gate(self):
        from Jotty.core.context.facade import get_content_gate
    ...
    def test_list_components_returns_dict(self):
        from Jotty.core.context.facade import list_components
