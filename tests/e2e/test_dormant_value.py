...
class TestByzantineValue:
    ...
    def test_liar_loses_trust_honest_keeps_it(self):
        ...
        assert (
            honest_trust - liar_trust
        ) > 0.5, f"Trust gap too small: honest={honest_trust}, liar={liar_trust}"
    ...
    def test_good_approach_gets_more_credit(self):
        ...
        for i in range(5):
            ...
            lp.credit_assigner.record_improvement_application(
                improvement={
                    "learned_pattern": "Use structured prompts with examples",
                    "task": "coding",
                },
                student_score=0.3,
                teacher_score=0.0,
        ...
        for i in range(5):
            ...
            lp.credit_assigner.record_improvement_application(
                improvement={
                    "learned_pattern": "Just try harder without structure",
                    "task": "coding",
                },
                student_score=0.3,
                teacher_score=0.0,
        ...
        assert (
            "structured prompts" in ranked[0]["learned_pattern"].lower()
...
class TestAdaptiveLearningValue:
    ...
    def test_plateau_increases_exploration(self):
        ...
        assert (
            state["is_plateau"] or state["exploration_rate"] > initial_explore
    ...
    def test_improving_scores_dont_trigger_plateau(self):
        ...
        assert state["is_converging"], f"All-perfect tail should detect convergence: {state}"
    ...
    def test_convergence_triggers_early_stop(self):
        ...
        assert (
            lp.adaptive_learning.should_stop_early()
