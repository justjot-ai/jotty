...
from Jotty.core.intelligence.orchestration.swarms.templates.ml import MLTemplate
...
def test_ml_template_backward_compatibility():
    ...
    from Jotty.core.intelligence.orchestration.swarms.templates.ml import MLSwarm
