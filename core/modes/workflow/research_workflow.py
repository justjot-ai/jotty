...
"""
        ...
        stage_prompts = {
            ...
            "overview": (
                "Research Analyst",
                f"""Provide comprehensive overview of the topic.
...
Output in markdown with citations.""",
            ...
            "deep_dive": (
                ...
                f"""Deep dive analysis of the topic.
...
Cite all sources. Use tables and lists for clarity.""",
            ...
            "synthesis": (
                "Synthesis Analyst",
                f"""Synthesize all research findings into coherent narrative.
...
Create comparison matrix.""",
            ...
            "trends": (
                "Trend Analyst",
                f"""Identify and analyze key trends.
...
Include diagrams if applicable.""",
            ...
            "architecture_analysis": (
                "Solutions Architect",
                f"""Analyze architecture and design.
...
Provide architecture diagrams in ASCII or describe in detail.""",
            ...
            "comparison": (
                "Comparison Analyst",
                f"""Compare alternative approaches/solutions.
...
Create comparison matrix with scoring.""",
            ...
            "competitor_profiles": (
                ...
                f"""Create detailed competitor profiles.
...
Be specific and actionable.""",
            ...
            "forecast": (
                "Forecasting Analyst",
                f"""Forecast future developments.
...
Use ASCII charts or describe charts in markdown.""",
            ...
            "documentation": (
                "Technical Writer",
                f"""Create comprehensive documentation.
