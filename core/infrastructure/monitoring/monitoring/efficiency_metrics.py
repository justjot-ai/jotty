...
class EfficiencyMetrics:
    ...
    def calculate_efficiency(
        ...
        if baseline_cost_per_success is not None:
            reduction = ((baseline_cost_per_success - cost_per_success) / baseline_cost_per_success) * 100
    ...
    def compare_efficiency(
        ...
        """
        # Cost reduction
        cost_reduction = ((baseline_cost_per_success - current_cost_per_success) / baseline_cost_per_success) * 100
        
        # Performance retention
        performance_retention = (current_performance / baseline_performance) * 100 if baseline_performance > 0 else 0.0
