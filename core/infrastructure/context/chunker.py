...
class ContextChunker:
    ...
    async def chunk_and_process(
        self, content: str, task_context: Dict, processor_fn: Callable, max_chunk_size: int = 10000
    ) -> str:
        """
    ...
    async def chunk(
        ...
        """
        logger.info(
            f" [AgentSlack API] Chunking: {len(data)} chars, chunk_size={chunk_size}, overlap={overlap}"
        )
