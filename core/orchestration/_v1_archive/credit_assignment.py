...
class CreditAssignment:
    ...
    def record_improvement_application(
        ...
        success_rate = credit.success_count / credit.application_count if credit.application_count > 0 else 0.0
        ...
        logger.debug(f"Recorded improvement application: {improvement_id}, delta: {score_delta:.3f}, credit: {credit.direct_credit:.3f}")
    ...
    def prioritize_improvements(
        ...
        for imp in improvements:
            ...
            if imp_id in self.improvement_credits:
                ...
                credit_score = credit.combined_credit if credit.combined_credit > 0 else credit.direct_credit
        ...
        for item in prioritized:
            ...
            if pattern_hash not in seen_patterns:
                ...
                for i, existing in enumerate(deduplicated):
                    if hash(existing["improvement"].get('learned_pattern', '').lower()[:100]) == pattern_hash:
    ...
    def prune_low_impact_improvements(
        ...
        for imp in improvements:
            ...
            if imp_id in self.improvement_credits:
                ...
                if (credit_score >= min_credit_threshold and 
                    credit.application_count >= min_application_count):
                    pruned.append(imp)
            else:
    ...
    def get_credit_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_counterfactual_credit": sum(c.counterfactual_credit for c in credits) / len(credits),
