...
class TemplateRegistry:
    ...
    @classmethod
    def auto_detect(cls, X: Any, y: Any = None, **kwargs: Any) -> SwarmTemplate:
        """
    ...
    @classmethod
    def _detect_data_type(cls, X: Any) -> str:
    ...
    @classmethod
    def _detect_problem_type(cls, y: Any) -> str:
    ...
    @classmethod
    def _detect_temporal(cls, X: Any) -> bool:
