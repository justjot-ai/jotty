...
_LAZY_IMPORTS: dict[str, str] = {
    ...
    "ChatContext": ".jotty",
    "ChatMessage": ".jotty",
    "ChatExecutor": ".intelligence.orchestration.use_cases.chat.chat_executor",
    "ChatOrchestrator": ".intelligence.orchestration.use_cases.chat.chat_orchestrator",
    "WorkflowContext": ".jotty",
    "WorkflowExecutor": ".intelligence.orchestration.use_cases.workflow.workflow_executor",
    "WorkflowOrchestrator": ".intelligence.orchestration.use_cases.workflow.workflow_orchestrator",
    "JottyAPI": ".jotty",
    "ChatAPI": ".jotty",
    "WorkflowAPI": ".jotty",
