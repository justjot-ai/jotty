    ...
    def _create_domain_agent(self, improvements: Optional[List[Dict[str, Any]]] = None) -> Any:
        ...
        class MermaidGenerationSignature(dspy.Signature):
            ...
            diagram_type: str = dspy.InputField(
                desc="Type of diagram: flowchart, sequence, class, state, etc."
            )
    ...
    def _create_domain_teacher(self) -> Any:
        ...
        class MermaidTeacherSignature(dspy.Signature):
            ...
            gold_standard: str = dspy.InputField(
                desc="The EXACT Mermaid code to return. Copy this EXACTLY without modification."
            )
            ...
            output: str = dspy.OutputField(
                desc="ONLY the Mermaid code from gold_standard. No explanation. No evaluation. Just the code."
            )
        ...
        try:
            ...
            if validator:
                ...
                return {
                    ...
                    "status": (
                        "CORRECT"
                        if is_valid and matches_gold
                        else ("PARTIAL" if is_valid else "INCORRECT")
                    ),
