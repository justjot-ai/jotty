...
def _load_signatures() -> None:
    ...
    from ..types.planner_signatures import (
        CapabilityInferenceSignature as _CI,  # type: ignore[import-not-found]
    )
    from ..types.planner_signatures import ExecutionPlanningSignature as _EP
    from ..types.planner_signatures import ReflectivePlanningSignature as _RP
    from ..types.planner_signatures import SkillSelectionSignature as _SS
    from ..types.planner_signatures import TaskTypeInferenceSignature as _TT
