...
if TYPE_CHECKING:
    from ..core.swarm_manager import Orchestrator
...
class SwarmDAGExecutor:
    ...
    async def run(
        ...
        **kwargs: Any,
        ...
        """
        from Jotty.core.intelligence.reasoning.planners.dag_agents import (  # type: ignore[import-not-found, import]
            TaskBreakdownAgent,
            TodoCreatorAgent,
        )
    ...
    def get_agents(self) -> Tuple:
        ...
        from Jotty.core.intelligence.reasoning.planners.dag_agents import (
            TaskBreakdownAgent,
            TodoCreatorAgent,
        )
