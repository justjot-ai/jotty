...
Canonical location: orchestration/intent/ (orchestration-level execution).
Moved from reasoning/autonomous/enhanced_executor.py.
"""
...
from Jotty.core.intelligence.reasoning.planners.agentic_planner import TaskPlan
...
class AutonomousExecutor:
    ...
    def __init__(self, auto_agent: Optional[AutoAgent] = None) -> None:
        ...
        try:
            from Jotty.core.capabilities.registry.skill_dependency_manager import (
