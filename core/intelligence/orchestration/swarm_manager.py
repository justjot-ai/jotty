...
from Jotty.core.infrastructure.utils.async_utils import safe_status, StatusReporter
...
def _load_providers() -> bool:
    ...
    try:
        ...
        from Jotty.core.capabilities.skills.providers.open_interpreter_provider import OpenInterpreterProvider
...
class AgentFactory:
    ...
    def create_zero_config_agents(self, task: str, status_callback: Optional[Callable] = None) -> List[AgentConfig]:
        ...
        if not hasattr(sm, '_zero_config_factory') or sm._zero_config_factory is None:
            from Jotty.core.intelligence.orchestration.zero_config_factory import ZeroConfigAgentFactory
    ...
    def init_lotus_optimization(self) -> None:
        ...
        sm = self._manager
        try:
            from Jotty.core.infrastructure.integration.lotus.integration import LotusEnhancement, _enhance_agent_runner
...
class ExecutionEngine:
    ...
    async def run(self, goal: str, **kwargs: Any) -> EpisodeResult:
        ...
        try:
            from Jotty.core.infrastructure.monitoring.observability import get_tracer, get_metrics
            _tracer = get_tracer()
...
class Orchestrator:
    ...
    def __init__(self, agents: Optional[Union[AgentConfig, List[AgentConfig], str]] = None, config: Optional[SwarmConfig] = None, architect_prompts: Optional[List[str]] = None, auditor_prompts: Optional[List[str]] = None, enable_zero_config: bool = True, enable_lotus: bool = True, max_concurrent_agents: int = 3) -> None:
        ...
        from Jotty.core.intelligence.orchestration.execution_orchestrator import ExecutionOrchestrator
