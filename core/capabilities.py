...
def _utilities() -> Dict[str, Any]:
    return {
        "BudgetTracker": {
            "import_path": "from Jotty.core.utils.budget_tracker import BudgetTracker",
            "description": "Track and limit LLM spending per scope",
        },
        "CircuitBreaker": {
            "import_path": "from Jotty.core.utils.timeouts import CircuitBreaker",
            "description": "Fail-fast pattern for unreliable services",
        },
        "LLMCallCache": {
            "import_path": "from Jotty.core.utils.llm_cache import LLMCallCache",
            "description": "Semantic caching for LLM calls",
        },
        "SmartTokenizer": {
            "import_path": "from Jotty.core.utils.tokenizer import SmartTokenizer",
...
def _explanations() -> Dict[str, str]:
    return {
        ...
        "workflow": (
            ...
            "Or via TierExecutor:\n"
            "  from Jotty.core.execution import TierExecutor, ExecutionConfig\n"
