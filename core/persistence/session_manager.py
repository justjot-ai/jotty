...
class SessionManager:
    ...
    def get_session_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'has_brain_state': (self.session_dir / "jotty_state" / "brain_state" / "consolidated.json").exists(),
            'has_todos': (self.session_dir / "jotty_state" / "markovian_todos" / "session_todo.md").exists(),
        }
