        ...
        if DSPY_AVAILABLE:
            ...
            class AnalyzeArtifactSignature(dspy.Signature):
                ...
                context: str = dspy.InputField(
                    desc="Context about where this artifact came from"
                )
    ...
    def _get_preview(self, artifact: Any, artifact_type: ArtifactType) -> str:
        ...
        try:
            if artifact_type == ArtifactType.DATAFRAME:
                ...
                return json.dumps(artifact[:10] if len(artifact) > 10 else artifact, default=str)[:2000]
...
class SemanticTagger:
        ...
        if DSPY_AVAILABLE:
            class GenerateTagsSignature(dspy.Signature):
                ...
                description: str = dspy.InputField(
                    desc="Description of the artifact"
                )
                key_fields: str = dspy.InputField(
                    desc="Key fields in the artifact"
                )
                artifact_type: str = dspy.InputField(
                    desc="Type of artifact"
                )
    ...
    def tag(self, analysis: AnalysisResult) -> TaggingResult:
        ...
        tags = [
            analysis.artifact_type.value,
            *analysis.key_fields[:5]
        ]
        ...
        try:
            ...
            if tags:
                ...
                tagging = TaggingResult(
                    tags=[artifact_type.value, source_actor],
                    confidence=0.5
                )
