...
class SmartConfig:
    ...
    def from_simple(
        ...
        model: str = "gpt-4.1",
        base_path: str = "agent_generated/memory/jotty",
    ) -> SwarmConfig:
        """
    ...
    def _from_intermediate(cls, intermediate: Dict) -> SwarmConfig:
        ...
        memory_sizes = {"small": 500, "medium": 2000, "large": 10000}
...
class JottyUniversal:
    ...
    def __init__(
        ...
        self.context_guard = ContextGuard(
            max_context_tokens=self.config.max_context_tokens, safety_margin=0.9
        )
    ...
    def _normalize_validator(self, spec: ValidatorSpec, is_architect: bool) -> Callable:
        """
    ...
    async def arun(self, **kwargs: Any) -> Dict:
        ...
        if self.context_guard.estimate_tokens(context_str) > self.config.max_context_tokens * 0.9:
            ...
            truncated = self.context_guard.check_and_truncate(
                system_prompt="", user_input=context_str, context="", memories=[], trajectory=""
            )
    ...
    def _update_learning(
        self, kwargs: Dict, output: Any, architect: Dict, auditor: Dict, success: bool
    ) -> Any:
...
__all__ = ["JottyUniversal", "SmartConfig", "jotty_universal", "detect_actor_type", "ActorType"]
