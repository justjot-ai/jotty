...
Usage:
    from Jotty.core.registry.builtin_widgets import (
...
def register_supervisor_widgets_to_catalog(
    ...
    Example:
        from Jotty.core.metadata import WidgetDefinition, A2UIComponent
        from Jotty.core.registry.builtin_widgets import register_supervisor_widgets_to_catalog
