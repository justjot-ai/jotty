...
class MathLaTeXExpertAgent(BaseExpert):
    ...
    def _create_domain_agent(self, improvements: Optional[List[Dict[str, Any]]] = None) -> Any:
        ...
        class MathLaTeXGenerationSignature(dspy.Signature):
            ...
            """
            task: str = dspy.InputField(desc="Task description (e.g., 'Generate quadratic formula')")
            description: str = dspy.InputField(desc="Mathematical description of the expression to generate")
            ...
            output: str = dspy.OutputField(desc="Complete Math LaTeX expression. Use $...$ for inline or $$...$$ for display math.")
        ...
        if improvements:
            try:
                ...
                signature_class = inject_improvements_into_signature(MathLaTeXGenerationSignature, improvements)
            except ImportError:
    ...
    def _create_domain_teacher(self) -> Any:
        ...
        class MathLaTeXTeacherSignature(dspy.Signature):
            ...
            output: str = dspy.OutputField(desc="Correct Math LaTeX expression. Use $...$ for inline or $$...$$ for display.")
