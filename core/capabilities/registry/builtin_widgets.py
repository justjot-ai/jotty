        ...
        return {
            ...
            "component_tree": [
                ...
                },
                {
                    "id": "list-1",
                    "component_type": "List",
                    "props": {"items": "{{tasks}}", "itemTemplate": "task-item-1"},
                },
                {
                    "id": "task-item-1",
                    "component_type": "Row",
                ...
                },
                {
                    "id": "task-text-1",
                    "component_type": "Text",
                    "props": {"value": "{{item.title}}", "style": "body"},
                },
                {
                    "id": "task-status-1",
                    "component_type": "Text",
                    "props": {"value": "{{item.status}}", "style": "caption"},
                },
            ],
            "data_schema": {
                "type": "object",
        ...
        return {
            ...
            "component_tree": [
                ...
                },
                {
                    "id": "stat-1-icon",
                    "component_type": "Icon",
                    "props": {"name": "{{stats[0].icon}}", "size": "large"},
                },
                {
                    "id": "stat-1-value",
                    "component_type": "Text",
                    "props": {"value": "{{stats[0].value}}", "style": "h3"},
                },
                {
                    "id": "stat-1-label",
                    "component_type": "Text",
            ...
            "component_tree": [
                {
                    "id": "card-1",
                    "component_type": "Card",
                    "props": {"title": "Orchestrator Status", "subtitle": "{{update_time}}"},
                    "children": ["col-1"],
                },
                {
                    "id": "col-1",
                ...
                },
                {
                    "id": "status-label",
                    "component_type": "Text",
                    "props": {"value": "Status:", "style": "body"},
                },
                {
                    "id": "status-value",
                    "component_type": "Text",
                    "props": {"value": "{{status}}", "style": "h4"},
                },
                {
                    "id": "metrics-row",
                    "component_type": "Column",
                ...
                },
                {
                    "id": "metric-1",
                    "component_type": "Text",
                    "props": {"value": "Active Tasks: {{active_tasks}}", "style": "body"},
                },
                {
                    "id": "metric-2",
                    "component_type": "Text",
                    "props": {"value": "Total Completed: {{completed_tasks}}", "style": "body"},
                },
                {
                    "id": "metric-3",
                    "component_type": "Text",
                    "props": {"value": "Success Rate: {{success_rate}}%", "style": "body"},
                },
            ],
            "data_schema": {
                "type": "object",
        ...
        return {
            ...
            "component_tree": [
                ...
                },
                {
                    "id": "icon-1",
                    "component_type": "Icon",
                    "props": {"name": "{{icon}}", "size": "medium"},
                },
                {
                    "id": "text-1",
                    "component_type": "Text",
                    "props": {"value": "{{message}}", "style": "body"},
                },
            ],
            "data_schema": {
                "type": "object",
...
def register_supervisor_widgets_to_catalog(
    catalog: Dict[str, Any], widget_definition_class: type, component_class: type
) -> Dict[str, Any]:
    """
